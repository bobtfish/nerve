...
* `extra`: a hash of extra data which will be serialized and registered. This can be used to report custom information (for example 'weight' to affect the haproxy backend weighting in synapse).
